...
Royal Rangers programme terminology (age groups, abbreviations) is documented in [docs/domain/royal-rangers-terminology.md](docs/domain/royal-rangers-terminology.md). Use `ageGroupLabels.ts` for UI display names — do not hardcode age group labels in components.
