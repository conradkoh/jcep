...
| `['user', 'jcep_admin']` | User with programme admin permissions |
...
The admin UI at `/app/admin/users` exposes **Standard User**, **JCEP Admin** (`jcep_admin`), and **System Administrator** presets.
